    ...
    return (
      <React.Fragment>
        <div className="data">
          ...
          <p className="desc">Spotify, LastFM, and TheMovieDB were scraped using curl commands and saved into a json file for further data processsing. The GitHub API was scraped using the python requests library and the total commits and issues are updated when the page is refreshed.</p>
        </div>
      </React.Fragment>
    );
  }
